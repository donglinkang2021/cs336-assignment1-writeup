...
\begin{table}[h]
    ...
    \begin{tabular}{c|c|c|c|c}
        ...
        \midrule
        GPT-2 Small & 162M & 117M & +45M & 38.46\% \\
        GPT-2 Medium & 405M & 345M & +60M & 17.39\% \\
        GPT-2 Large & 837M & 762M & +75M & 9.84\% \\
        GPT-2 XL & 1636M & 1542M & +94M & 6.10\% \\
        \bottomrule
    \end{tabular}
    \caption{Comparison of our GPT-2 parameter count calculations with values reported in the original GPT-2 paper~\cite{radford2019language}.}
...
\begin{lstlisting}
GPT-2 small 162.148608 M params
GPT-2 medium 404.9664 M params
GPT-2 large 836.54016 M params
GPT-2 XL 1.6355376 B params
\end{lstlisting}