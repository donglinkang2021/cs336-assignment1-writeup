...
% \setCJKmainfont{Noto Serif CJK SC}[BoldFont=Noto Sans CJK SC Bold] % for Linux
\setCJKmainfont[BoldFont={SimHei}]{SimSun} % for Windows
% \setCJKmainfont[BoldFont={Heiti SC}]{Songti SC} % for macOS
